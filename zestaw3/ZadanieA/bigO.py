...
if __name__ == "__main__":
    plot_data('time_complexity_getAndRemove_priorityQueue.txt', 'Time Complexity Analysis of getAndRemove Operation', 'Input Size (n)', 'Execution Time (seconds)', 'plot_getAndRemove_priorityQueue.png')
