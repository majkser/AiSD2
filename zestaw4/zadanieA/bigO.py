...
if __name__ == "__main__":
    plot_data('time_complexity_addEdge_graph.txt', 'Time Complexity Analysis of getAndRemove Operation', 'Input Size (n)', 'Execution Time (seconds)', 'time_complexity_addEdge_graph.png')
